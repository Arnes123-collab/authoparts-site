    ...
    <main className="min-h-screen bg-[var(--background)]">
      <section className="section-container py-10">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm font-black text-[var(--accent)]">Этап 11</p>
            <h1 className="text-4xl font-black">CMS упражнений</h1>
            <p className="mt-3 text-[var(--muted)]">Добавляйте упражнения, фото, технику, ошибки и ограничения.</p>
          </div>
